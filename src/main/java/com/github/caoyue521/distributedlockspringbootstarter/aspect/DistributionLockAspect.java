package com.github.caoyue521.distributedlockspringbootstarter.aspect;


import com.github.caoyue521.distributedlockspringbootstarter.annotation.DistributedLock;
import com.github.caoyue521.distributedlockspringbootstarter.lock.DistributedLockCallback;
...
public class DistributionLockAspect {
    ...
    @Pointcut("@annotation(com.github.caoyue521.distributedlockspringbootstarter.annotation.DistributedLock)")
    ...
    public void afterThrowing(RuntimeException ex) {
        log.error("DistributedLock error,the error is :{}",ex.getMessage());
        throw ex;
    }
    ...
    public Object lock(ProceedingJoinPoint pjp, Method method, final String lockName) {
        ...
        boolean renewalLock = annotation.renewalLock();
        if(renewalLock){
    ...
    public Object lock(ProceedingJoinPoint pjp, final String lockName){
